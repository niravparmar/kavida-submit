...
class Home(Resource):
    ...
    def get(self):
        try:
            return {'message': "Welcome to Kavida-Demo APIs-SQL"}, 200
        except:
    ...
    def get(self):
        ...
        try:
            ...
            if data['page'] and data['limit']:
                ...
                response = News.get_news_by_filter(self, timestampfinal, severityfinal)
...
class AddNews(Resource):
    ...
    def post(self):
        ...
        if len(data['categories']) <= 3 and data['title'] and data['timestamp'] and data['reliability'] and data[
            ...
            try:
                News(
                    data['title'], data['timestamp'], data['reliability'],
                    data['severity'], data['summary'], data['newsLink'], str(data['categories'])
                ).save_to_db()
